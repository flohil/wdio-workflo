...
const Steps = {
    ...
    "fill data in container settings dialog in content administration": (params) => new steps_1.ParameterizedStep(steps_1.mergeStepDefaults({ formValues: { var1: 1 } }, params), ({ formValues }) => {
    }),
