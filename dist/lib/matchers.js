...
exports.elementMatchers = {
    ...
    toHaveText: elementMatcherFunction(({ node, expected }) => [node.currently.hasText(expected), node.currently.not.hasText(expected)], ({ actual, expected }) => createLongErrorMessage('text', 'be', actual, expected)),
    toHaveAnyText: elementMatcherFunction(({ node }) => [node.currently.hasAnyText(), node.currently.not.hasAnyText()], () => " to have any text"),
    toContainText: elementMatcherFunction(({ node, expected }) => [node.currently.containsText(expected), node.currently.not.containsText(expected)], ({ actual, expected }) => createLongErrorMessage('text', 'contain', actual, expected)),
    toHaveValue: elementMatcherFunction(({ node, expected }) => [node.currently.hasValue(expected), node.currently.not.hasValue(expected)], ({ actual, expected }) => createLongErrorMessage('value', 'be', actual, expected)),
    toHaveAnyValue: elementMatcherFunction(({ node }) => [node.currently.hasAnyValue(), node.currently.not.hasAnyValue()], () => " to have any value"),
    toContainValue: elementMatcherFunction(({ node, expected }) => [node.currently.containsValue(expected), node.currently.not.containsValue(expected)], ({ actual, expected }) => createLongErrorMessage('value', 'contain', actual, expected)),
    toHaveHTML: elementMatcherFunction(({ node, expected }) => [node.currently.hasHTML(expected), node.currently.not.hasHTML(expected)], ({ actual, expected }) => createLongErrorMessage('HTML', 'be', actual, expected)),
    toHaveAnyHTML: elementMatcherFunction(({ node }) => [node.currently.hasAnyHTML(), node.currently.not.hasAnyHTML()], () => ` to have any HTML`),
    toContainHTML: elementMatcherFunction(({ node, expected }) => [node.currently.containsHTML(expected), node.currently.not.containsHTML(expected)], ({ actual, expected }) => createLongErrorMessage('HTML', 'contain', actual, expected)),
    toHaveDirectText: elementMatcherFunction(({ node, expected }) => [node.currently.hasDirectText(expected), node.currently.not.hasDirectText(expected)], ({ actual, expected }) => createLongErrorMessage('direct text', 'be', actual, expected)),
    toHaveAnyDirectText: elementMatcherFunction(({ node }) => [node.currently.hasAnyDirectText(), node.currently.not.hasAnyDirectText()], () => ` to have any direct text`),
    toContainDirectText: elementMatcherFunction(({ node, expected }) => [node.currently.containsDirectText(expected), node.currently.not.containsDirectText(expected)], ({ actual, expected }) => createLongErrorMessage('direct text', 'contain', actual, expected)),
    ...
    toHaveClass: elementMatcherFunction(({ node, expected }) => [node.currently.hasClass(expected), node.currently.not.hasClass(expected)], ({ actual, expected }) => createLongErrorMessage('class', 'be', actual, expected)),
    toContainClass: elementMatcherFunction(({ node, expected }) => [node.currently.containsClass(expected), node.currently.not.containsClass(expected)], ({ actual, expected }) => createLongErrorMessage('class', 'contain', actual, expected)),
    toHaveId: elementMatcherFunction(({ node, expected }) => [node.currently.hasId(expected), node.currently.not.hasId(expected)], ({ actual, expected }) => createLongErrorMessage('id', 'be', actual, expected)),
    toHaveAnyId: elementMatcherFunction(({ node }) => [node.currently.hasAnyId(), node.currently.not.hasAnyId()], () => ` to have any id`),
    toContainId: elementMatcherFunction(({ node, expected }) => [node.currently.containsId(expected), node.currently.not.containsId(expected)], ({ actual, expected }) => createLongErrorMessage('id', 'contain', actual, expected)),
    toHaveName: elementMatcherFunction(({ node, expected }) => [node.currently.hasName(expected), node.currently.not.hasName(expected)], ({ actual, expected }) => createLongErrorMessage('name', 'be', actual, expected)),
    toHaveAnyName: elementMatcherFunction(({ node }) => [node.currently.hasAnyName(), node.currently.not.hasAnyName()], () => ` to have any name`),
    toContainName: elementMatcherFunction(({ node, expected }) => [node.currently.containsName(expected), node.currently.not.containsName(expected)], ({ actual, expected }) => createLongErrorMessage('name', 'contain', actual, expected)),
    toHaveLocation: elementMatcherFunction(({ node, expected, opts }) => [node.currently.hasLocation(expected, opts.tolerances), node.currently.not.hasLocation(expected, opts.tolerances)], ({ actual, expected, opts }) => createLongErrorMessage('location', (opts.tolerances && (opts.tolerances.x > 0 || opts.tolerances.y > 0)) ? 'be within' : 'be', helpers_1.tolerancesObjectToString(actual), helpers_1.tolerancesObjectToString(expected))),
    toHaveX: elementMatcherFunction(({ node, expected, opts }) => [node.currently.hasX(expected, opts.tolerance), node.currently.not.hasX(expected, opts.tolerance)], ({ actual, expected, opts }) => createLongErrorMessage('x', (opts.tolerance && opts.tolerance > 0) ? 'be within' : 'be', helpers_1.tolerancesObjectToString(actual), helpers_1.tolerancesObjectToString(expected))),
    toHaveY: elementMatcherFunction(({ node, expected, opts }) => [node.currently.hasY(expected, opts.tolerance), node.currently.not.hasY(expected, opts.tolerance)], ({ actual, expected, opts }) => createLongErrorMessage('y', (opts.tolerance && opts.tolerance > 0) ? 'be within' : 'be', helpers_1.tolerancesObjectToString(actual), helpers_1.tolerancesObjectToString(expected))),
    ...
    toEventuallyHaveLocation: elementMatcherFunction(({ node, expected, opts }) => [node.eventually.hasLocation(expected, opts), node.eventually.not.hasLocation(expected, opts)], ({ actual, expected, opts }) => createEventuallyErrorMessage('location', (opts.tolerances && (opts.tolerances.x > 0 || opts.tolerances.y > 0)) ? 'be within' : 'be', helpers_1.tolerancesObjectToString(actual), helpers_1.tolerancesObjectToString(expected), opts.timeout)),
    toEventuallyHaveX: elementMatcherFunction(({ node, expected, opts }) => [node.eventually.hasX(expected, opts), node.eventually.not.hasX(expected, opts)], ({ actual, expected, opts }) => createEventuallyErrorMessage('x', (opts.tolerance && opts.tolerance > 0) ? 'be within' : 'be', helpers_1.tolerancesObjectToString(actual), helpers_1.tolerancesObjectToString(expected), opts.timeout)),
    toEventuallyHaveY: elementMatcherFunction(({ node, expected, opts }) => [node.eventually.hasY(expected, opts), node.eventually.not.hasY(expected, opts)], ({ actual, expected, opts }) => createEventuallyErrorMessage('y', (opts.tolerance && opts.tolerance > 0) ? 'be within' : 'be', helpers_1.tolerancesObjectToString(actual), helpers_1.tolerancesObjectToString(expected), opts.timeout)),
    toEventuallyHaveSize: elementMatcherFunction(({ node, expected, opts }) => [node.eventually.hasSize(expected, opts), node.eventually.not.hasSize(expected, opts)], ({ actual, expected, opts }) => createEventuallyErrorMessage('size', (opts.tolerances && (opts.tolerances.width > 0 || opts.tolerances.height > 0)) ? 'be within' : 'be', helpers_1.tolerancesObjectToString(actual), helpers_1.tolerancesObjectToString(expected), opts.timeout)),
    toEventuallyHaveWidth: elementMatcherFunction(({ node, expected, opts }) => [node.eventually.hasWidth(expected, opts), node.eventually.not.hasWidth(expected, opts)], ({ actual, expected, opts }) => createEventuallyErrorMessage('width', (opts.tolerance && opts.tolerance > 0) ? 'be within' : 'be', helpers_1.tolerancesObjectToString(actual), helpers_1.tolerancesObjectToString(expected), opts.timeout)),
    toEventuallyHaveHeight: elementMatcherFunction(({ node, expected, opts }) => [node.eventually.hasHeight(expected, opts), node.eventually.not.hasHeight(expected, opts)], ({ actual, expected, opts }) => createEventuallyErrorMessage('height', (opts.tolerance && opts.tolerance > 0) ? 'be within' : 'be', helpers_1.tolerancesObjectToString(actual), helpers_1.tolerancesObjectToString(expected), opts.timeout))
};
