...
export declare const testcase: (description: string, metadata: Workflo.ITestcaseMetadata, bodyFunc: () => void, jasmineFunc?: (description: string, bodyFunc: () => void, retries: number) => void) => void;
